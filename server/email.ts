...
export async function sendBetaInviteEmail({
  ...
  const { data, error } = await resend.emails.send({
    from: FROM,
    to,
    subject: "Tu acceso beta a Alegatto está listo",
    html: `
<!DOCTYPE html>
<html lang="es">
<head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"></head>
  ...
  <table width="100%" cellpadding="0" cellspacing="0" style="background-color:#0f172a;padding:40px 20px;">
    <tr><td align="center">
      <table width="600" cellpadding="0" cellspacing="0" style="background-color:#1e293b;border-radius:12px;overflow:hidden;max-width:600px;width:100%;">
        <tr>
          <td style="background:linear-gradient(135deg,#064e3b,#065f46);padding:32px 40px;text-align:center;">
            <h1 style="margin:0;color:#10b981;font-size:28px;font-weight:700;">Alegatto</h1>
            <p style="margin:8px 0 0;color:#6ee7b7;font-size:14px;">Plataforma de IA Legal para Costa Rica</p>
          </td>
        </tr>
        <tr>
          <td style="padding:40px;">
            <h2 style="margin:0 0 16px;color:#f1f5f9;font-size:22px;font-weight:600;">Fuiste invitado al programa beta</h2>
            <p style="margin:0 0 16px;color:#94a3b8;font-size:15px;line-height:1.6;">
              Tienes acceso gratuito al plan <strong style="color:#10b981;">Pro</strong> de Alegatto — el asistente legal con IA para abogados costarricenses.
            </p>
            <div style="background:#0f172a;border:1px solid #334155;border-radius:8px;padding:16px 20px;margin:0 0 24px;text-align:center;">
              <p style="margin:0 0 4px;color:#64748b;font-size:12px;text-transform:uppercase;letter-spacing:1px;">Tu código beta</p>
              <p style="margin:0;color:#10b981;font-size:24px;font-weight:700;letter-spacing:3px;font-family:monospace;">${code}</p>
            </div>
            <table cellpadding="0" cellspacing="0" style="margin:0 auto 24px;">
              <tr>
                <td style="background-color:#10b981;border-radius:8px;">
                  <a href="${betaLink}" style="display:inline-block;padding:14px 36px;color:#ffffff;font-size:16px;font-weight:600;text-decoration:none;">
            ...
            <p style="margin:0;color:#64748b;font-size:13px;text-align:center;">
              ...
              <a href="${betaLink}" style="color:#10b981;word-break:break-all;">${betaLink}</a>
            </p>
          </td>
        </tr>
        <tr>
          <td style="background-color:#0f172a;padding:20px 40px;text-align:center;">
            <p style="margin:0;color:#475569;font-size:12px;">© 2026 Alegatto · Costa Rica</p>
          </td>
        </tr>
      </table>
    </td></tr>
